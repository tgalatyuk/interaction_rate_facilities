...
// Date update: 2023-Aug-18  ALICE3 interaction rate up to 93 kHz for Pb-Pb
// Date update: 2024-Feb-24  ALICE and sPHENIX marked as running, CEE+@HIAF marked as under construction
// Author: T. Galatyuk
...
//    can_exp->SetGridy();
    ...
    // ALICE3
    TArrow *arrow = new TArrow(150,93000,250,93000,0.01,">");
    arrow->SetLineWidth(3);
    arrow->SetLineStyle(2);
    arrow->SetLineColor(kBlue+1);
    arrow->SetAngle(51);
    arrow->Draw();
    TArrow *arrow = new TArrow(235,93000,250,93000,0.01,">");
    arrow->SetLineWidth(3);
    ...
    TPaveText *pt = new TPaveText(105,5e4,105,5e4);
    pt->SetBorderSize(0);
    pt->SetFillColor(0);
    pt->SetLineColor(0);
    pt->SetTextSize(0.025);
    ...
    TPaveText *pt = new TPaveText(100,1.e5,100,1.e5);
    pt->SetBorderSize(0);
    pt->SetFillColor(0);
    pt->SetLineColor(0);
    pt->SetTextSize(0.025);
    pt->SetTextColor(1);
    pt->SetTextFont(42);
    TText *text = pt->AddText("ALICE3@LHC");
    pt->Draw();

    TPaveText *pt = new TPaveText(135,2.2e4,135,2.2e4);
    pt->SetBorderSize(0);
    pt->SetFillColor(0);
    pt->SetLineColor(0);
    pt->SetTextSize(0.025);
